...
def plot_epipolar_lines(image1, image2, uncalibrated_1, uncalibrated_2, E, F, plot=True):
    """ Plots the epipolar lines on the images
    """
    
    # F is passed as an argument
    # F = np.linalg.inv(K).T @ E @ np.linalg.inv(K)
    
    # assuming uncalibrated_1 and _2 are Nx3 vectors
    # print('uncalibrated_2.shape = ', uncalibrated_2.shape)
    # print('uncalibrated_1.shape = ', uncalibrated_1.shape)
    
    epipolar_lines_in_1 = F.T @ uncalibrated_2    # E.T x2
    
    epipolar_lines_in_2 = F @ uncalibrated_1      # E x1
